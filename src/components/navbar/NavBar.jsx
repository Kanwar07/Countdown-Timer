...
function NavBar() {
  return (
    <>
      <div class="flex p-4 justify-around w-screen bg-gradient-to-r from-[#BDC3C7] to-[#2C3E50] cursor-pointer">
        <img
          ...
          alt="stopwatch"
        />
        <div class="border-2 text-[20px] italic flex items-center pl-4 pr-4 shadow-xl rounded-lg cursor-pointer max-sm:hidden">
